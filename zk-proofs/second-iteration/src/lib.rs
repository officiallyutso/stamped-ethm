...
mod witness {
    rust_witness::witness!(imageproof);
}

crate::set_circom_circuits! {
    ("imageproof.zkey", circom_prover::witness::WitnessFn::RustWitness(witness::imageproof_witness)),
}
...
mod circom_tests {
    ...
    const ZKEY_PATH: &str = "./test-vectors/circom/imageproof.zkey";
